...
curl -sL "https://raw.githubusercontent.com/fredporter/uDESK/main/build/uDOS-core/usr/local/share/udos/templates/document.md" | sudo tee /usr/local/share/udos/templates/document.md > /dev/null || echo "Template download failed (optional)"
